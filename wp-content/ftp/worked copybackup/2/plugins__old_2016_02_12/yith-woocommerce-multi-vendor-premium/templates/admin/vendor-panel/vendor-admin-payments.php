...
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="admin.php" enctype="multipart/form-data">
        <h3><?php _e( 'Payments information', 'yith_wc_product_vendors' ) ?></h3>
        ...
        <?php if( 'choose' == get_option( 'payment_method' ) ) : ?>
            <div class="form-field">
                <label for="vendor_payment_type"><?php  _e( 'Payment type:', 'yith_wc_product_vendors' ) ?></label>
                ...
                <br />
                <span class="description"><?php _e( 'Choose payment method for crediting commissions', 'yith_wc_product_vendors' ); ?></span>
            </div>


            <div class="form-field">
                <label class="yith_vendor_payment_threshold" for="yith_vendor_payment_threshold"><?php _e( 'Threshold', 'yith_wc_product_vendors' ); ?></label>
                ...
                <span class="description"><?php printf( '%s (%s: <strong>%s</strong>).',
                        __( "Minimum vendor's earning before a vendor's commissions can be paid", 'yith_wc_product_vendors' ),
                        __('Minimum threshold allowed by site administrator is', 'yith_wc_product_vendors' ),
        ...
        <?php endif; ?>
         ...
         <div class="submit">
            <input name="Submit" type="submit" class="button-primary" value="<?php echo esc_attr( __( 'Save Payments Information', 'yith_wc_product_vendors' ) ) ?>" />
        </div>
    </form>
</div>