...
return array(
    ...
    'size-charts'      => array(
        ...
        'option_desc'       => __( 'If you enable this option, vendors will be able to add product size charts for their own products', 'yith_wc_product_vendors' ),
    ...
    'live-chat'       => array(
        ...
        'capabilities'      => apply_filters( 'yith_ylc_vendor_caps', yith_wcmv_create_capabilities( array( 'ylc-macro', 'ylc-macros' ) ) ),
        'premium'           => 'YLC_PREMIUM',
    ...
    'pdf-invoice' => array(
        ...
        'option_desc'       => __( 'If you enable this option, vendors will be able to create invoice for their order. This feature require that vendor are able to manage their order individually', 'yith_wc_product_vendors' ),
    ...
    'request-quote' => array(
        ...
        'option_desc'       => __( 'If you enable this option, vendors will be able to receive and manage their order quote. This feature require that vendor are able to manage their order individually', 'yith_wc_product_vendors' ),
