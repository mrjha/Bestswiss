...
Now in version 1.2.6 with several bugs fixes reported in forum. 1.2.7 is in progress and will be available by end December 2015.

Google SEO Author Snippet Plugin is now Google SEO Pressor for Rich snippets. You can automate Google Structured data for your wordpress posts, pages, custom posts and categories wide easily using Google SEO Pressor for Rich snippets.   And Remove option is added for applied  Rich snippets.  
...
* Fixed: Displays only the seleted rich snippet in each post types
...
= 1.2.6 =   Upgrade for more bug fixes

= 1.2.5 =    Upgrade for bug fixes and added remove option for snippets
...
= 1.2.1 =	Upgrade for dynamic debug mode enable/disable feature.
