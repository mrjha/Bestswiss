...
if(!class_exists('Ultimate_Info_Circle'))
{
	class Ultimate_Info_Circle
	{
		...
		{
			wp_register_script("info-circle",plugins_url("../assets/js/info-circle.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
		...
		function info_circle_item($atts,$content = null)
		{
			...
			if($icon_type == "selector"){						
				...
				$img = info_imgapply_filters('ult_get_img_single', $info_img, 'url');			
