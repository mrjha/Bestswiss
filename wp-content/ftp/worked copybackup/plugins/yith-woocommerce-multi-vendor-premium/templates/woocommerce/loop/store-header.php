        ...
        <div class="store-contact">
            ...
            <?php if( $show_vendor_vat && ! empty( $vendor->vat ) ) : ?>
                <span class="store-vat">
                    ...
                    <?php printf( __( 'VAT/SSN: %s', 'yith_wc_product_vendors' ), $vendor->vat ); ?>
                </span>
            <?php endif; ?>
            <?php if( ! empty( $vendor->legal_notes ) ) : ?>
                <span class="store-vat">
                    <i class="<?php echo $icons['legal_notes'] ?>"></i>
                    <?php printf( __( '%s', 'yith_wc_product_vendors' ), $vendor->legal_notes ); ?>
                </span>
            <?php endif; ?>
            ...
            <?php if( $show_total_sales ) : ?>
                <span class="store-sales">
                    ...
                    <?php printf( __( 'Total sales: %d', 'yith_wc_product_vendors' ), $total_sales ); ?>
                </span>
            <?php endif; ?>
        </div>
