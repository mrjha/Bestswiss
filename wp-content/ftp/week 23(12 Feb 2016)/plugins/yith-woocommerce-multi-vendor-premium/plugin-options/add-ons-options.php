...
return array(
    ...
    'add-ons' => array(
        ...
        'vendors_pdf_invoice_title'          => array(
            'title' => __( 'PDF Invoice', 'yith_wc_product_vendors' ),
            'type'  => 'title',
        ...
        'vendors_enable_pdf_invoice'         => array(
            'title'             => __( 'Enable PDF Invoice for vendors', 'yith_wc_product_vendors' ),
            'type'              => 'checkbox',
        ...
        'vendors_request_quote_title'        => array(
            'title' => __( 'Request a quote', 'yith_wc_product_vendors' ),
            'type'  => 'title',
        ...
        'vendors_enable_request_quote'       => array(
            'title'             => __( 'Enable Request a quote for vendors', 'yith_wc_product_vendors' ),
            'type'              => 'checkbox',
