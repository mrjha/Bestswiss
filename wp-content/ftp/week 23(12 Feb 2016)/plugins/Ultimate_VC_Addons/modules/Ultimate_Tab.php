	...
	if(isset($value['title'])) {
			...
			if($icon_position=='Right')
				...
				$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.' " data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.'" class="ult_a '.$css_class .'">
...
/*-------------------accordion left icon------------------*/
        	...
        	<a class="ult-tabto-actitle withBorder ult_a" style="color:'.$tab_title_color.';'.$style5bgcolor.';background-color:'.$tab_background_color.';'.$ult_ac_border.'" href="#">
				...
				{
					$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.'" data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.'" class="ult_a '.$icon_top_link.' '.$css_class .'">
...
/*-------------------accordion top icon------------------*/
	        	...
	        	<a class="ult-tabto-actitle withBorder ult_a" style="color:'.$tab_title_color.';'.$style5bgcolor.';background-color:'.$tab_background_color.';'.$ult_ac_border.'" href="#">
					...
					$icon_position='none';
					$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.'" data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.' " class="ult_a '.$ult_style.' '.$css_class .'">
					     <span class="ult_tab_main '.$resp_style.' ">
					 		 <span class="ult_tab_section">
...
$op .='<div class="ult_tab_min_contain">';
...
function ult_tab_init() {
	...
	$settings = array(
		...
		'admin_enqueue_css'       => preg_replace( '/\s/', '%20', plugins_url( 'vc_extend/css/sub-tab.css', __FILE__ ) ),
		...
		array(
			...
			"value" => array('Style 1'=>'Style_1','Style 2'=>'Style_2','Style 3'=>'Style_3','Style 4'=>'Style_4','Style 5'=>'Style_5'),
			"group" => "General ",
		),
		...
		array(
			...
			"dependency" => Array("element" => "tab_style","value" => array("Style_4","Style_1","Style_3","Style_5")),
			"edit_field_class" => "vc_col-sm-12 vc_column ult_space_border",
		 ),
...
function ultimate_tabs() {
		//wp_enqueue_script('jquery_min_js', plugins_url('../assets/js/jquery.min.js', __FILE__), array('jquery'), '1.0', false);
		
		wp_register_script('imd_ui_tabs_rotate',plugins_url( '../assets/min-js/ult_tab_script.min.js', __FILE__ ),array( 'jquery'),ULTIMATE_VERSION,true);	
		
		wp_register_style('imd_ui_tabs',plugins_url( '../assets/min-css/ult_tab_style.css', __FILE__ ));	

		wp_register_script('imd_ui_acordian_js',plugins_url( '../assets/min-js/ult_acordian.js', __FILE__ ),array( 'jquery'),ULTIMATE_VERSION,true);	
		
		wp_register_style('imd_ui_acordian',plugins_url( '../assets/min-css/ult_acord_acstyle.css', __FILE__ ));	
		
		
	}

function ultimate_tabs_admin() {
	wp_register_script('tab-js-1', plugins_url( 'vc_extend/js/ult_tab_admin_enqueue_js.js', __FILE__ ),array( 'jquery'),ULTIMATE_VERSION,true);
	wp_register_script('tab-js-2', plugins_url( 'vc_extend/js/single_element_js.js', __FILE__ ),array( 'jquery'),ULTIMATE_VERSION,true);

	wp_enqueue_script('tab-js-1');	
	wp_enqueue_script('tab-js-2');	
	wp_enqueue_style('css-1',plugins_url( 'vc_extend/css/sub-tab.css', __FILE__ ));
}
