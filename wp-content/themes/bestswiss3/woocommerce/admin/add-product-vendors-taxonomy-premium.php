...
<div class="form-field">
    <label for="yith_vendor_legal_notes">
        <?php _e( 'Company legal notes', 'yith_wc_product_vendors' ); ?>
    </label>
...
<div class="form-field">
    ...
    <label class="yith_vendor_enable_featured_products_label" for="yith_vendor_enable_featured_products"><?php _e( 'Enable Featured products management', 'yith_wc_product_vendors' ); ?></label>
