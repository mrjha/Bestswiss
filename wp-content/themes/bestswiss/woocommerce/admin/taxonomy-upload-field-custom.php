...
<?php echo $main_wrapper_start ?>
    <?php echo $is_table ? '<th scope="row" valign="top">' : '' ?>
        <label><?php //_e( $Label, 'yith_wc_product_vendors' ); ?></label><br/>
    ...
    <?php echo $is_table ? '<td>' : '' ?>
        ...
        <div style="line-height:60px;">
            ...
            <button type="button" class="<?php echo $upload_image_button ?> button"><?php _e( 'Upload/Add image', 'yith_wc_product_vendors' ); ?></button>
            <button type="button" class="<?php echo $remove_image_button ?> button"><?php _e( 'Remove image', 'yith_wc_product_vendors' ); ?></button>
        </div>
    <?php echo $is_table ? '</td>' : '' ?>
