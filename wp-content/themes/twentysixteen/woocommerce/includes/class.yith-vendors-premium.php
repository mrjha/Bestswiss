...
if ( !class_exists( 'YITH_Vendors_Premium' ) ) {
    ...
    class YITH_Vendors_Premium extends YITH_Vendors {
        ...
        public function __construct() {
            ...
            /* Load modules */
            add_action( 'admin_init', array( $this, 'load_modules' ) );
        ...
        public function get_social_fields() {
            return apply_filters( 'yith_vendors_admin_social_fields', array(
                    'social_fields' => array(
                        'facebook'  => array(
                            'label' => __( 'Facebook', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-facebook-square'
                        ),
                        'twitter'   => array(
                            'label' => __( 'Twitter', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-twitter-square'
                        ),
                        'google'    => array(
                            'label' => __( 'Google+', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-google-plus-square'
                        ),
                        'linkedin'  => array(
                            'label' => __( 'Linkedin', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-linkedin-square'
                        ),
                        'youtube'   => array(
                            'label' => __( 'Youtube', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-youtube-square'
                        ),
                        'vimeo'   => array(
                            'label' => __( 'Vimeo', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-vimeo-square'
                        ),
                        'instagram' => array(
                            'label' => __( 'Instagram', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-instagram'
                        ),
                        'pinterest' => array(
                            'label' => __( 'Pinterest', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-pinterest-square'
                        ),
                        'flickr'    => array(
                            'label' => __( 'Flickr', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-flickr'
                        ),
                        'behance'   => array(
                            'label' => __( 'Behance', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-behance-square'
                        ),
                        'tripadvisor  '   => array(
                            'label' => __( 'Tripadvisor  ', 'yith_wc_product_vendors' ),
                            'icon'  => 'fa-tripadvisor  '
                        ),
                    )
                )
