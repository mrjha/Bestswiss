    ...
    { 
        ...
        switch($data['type']){
            ...
            case "wbs_custom":
                ...
                $submin=($data['container']['min']['value'][$i])?$data['container']['min']['value'][$i]:0;

                $weighdelivery.="<input type='text' class='shipping".$inputname."".$key." wbs-minifield wc_input_decimal input-text' name='shipping[".$inputname."][".$key."][min][value][]' id='woowbs_main_subtotal_min' value='".$submin."'>";

                $subminckh=($data['container']['min']['inclusive'][$i])?"checked=checked":0;
                $weighdelivery.="<label> <input ".$subminckh." type='checkbox'  value='1' name='shipping[".$inputname."][".$key."][min][inclusive][]'> or equal
                                        </label>";


                $submaxval=($data['container']['max']['value'][$i])?$data['container']['max']['value'][$i]:0;
                $submaxchk=($data['container']['max']['inclusive'][$i])?"checked=checked":"";
                $weighdelivery.="</label>
                                        <label class='wbs-minifield-container customwbsmincontainer'>
                                        <span class='wbs-minifield-label'>below (".$currencysymbol.")</span>";
                $weighdelivery.="<input type='text' class='shipping".$inputname."".$key." wbs-minifield wc_input_decimal input-text' name='shipping[".$inputname."][".$key."][max][value][]' id='woowbs_main_subtotal_max' value='".$submaxval."'>
                                        <label> <input type='checkbox' ".$submaxchk." value='1' name='shipping[".$inputname."][".$key."][max][inclusive][]'> or equal
                                        </label>";

                $submaxcost=($data['container']['cost'][$i])?$data['container']['cost'][$i]:0;
                $weighdelivery.="</label>
                                         <label class='wbs-minifield-container customwbsmincontainer'>
                                                    <span class='wbs-minifield-label'>Cost (".$currencysymbol.")</span>
                                                    <input value='".$submaxcost."' type='text' class='shipping".$inputname."".$key." wbs-minifield wc_input_decimal input-text' name='shipping[".$inputname."][".$key."][cost][]' id='woowbs_main_weight_max'>
                                                </label>
                                        </fieldset>";
                                    }
